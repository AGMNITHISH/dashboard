...
const Home = () => {
  return (
    <div>
      ...
      <div className="block lg:flex p-4 gap-4">
        <div className="h-500 w-full xl:w-4/6 bg-gray-700 p-5 rounded-md md:relative  md:top-70- shadow-2xl">
        ...
        <div className="h-500 w-full xl:w-2/6 bg-white p-5 rounded-md md:relative my-4 lg:my-0 md:top-70- shadow-2xl">
